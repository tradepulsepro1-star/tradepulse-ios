...
+(NSString*)getLaunchImageName
{
    ...
    else if (UIInterfaceOrientationIsPortrait([[[UIApplication sharedApplication].windows.firstObject windowScene] interfaceOrientation]))//iPad Portrait
    {
...
+(void)configureWebView:(UIView*)wv
{
    ...
    if ([wv isKindOfClass:NSClassFromString(@"WKWebView")]) {
        ...
        [[[WebViewViewportManager alloc] init] setViewportWithScale:appConfig.initialWebviewZoom width:appConfig.forceViewportWidth webView:webview];
